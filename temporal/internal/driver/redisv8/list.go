...
// Equivalent of LRem.
func (r *RedisV8) Remove(ctx context.Context, key string, count int64, element interface{}) (int64, error) {
...
func (r *RedisV8) Range(ctx context.Context, key string, start, stop int64) ([]string, error) {
...
// Equivalent of LLen.
func (r *RedisV8) Length(ctx context.Context, key string) (int64, error) {
...
// Equivalent to LPush.
func (r *RedisV8) Prepend(ctx context.Context, pipelined bool, key string, values ...[]byte) error {
	if pipelined {
...
// When key holds a value that is not a list, an error is returned.
// Equivalent to RPush.
func (r *RedisV8) Append(ctx context.Context, pipelined bool, key string, values ...[]byte) error {
	if pipelined {
		pipe := r.client.Pipeline()
		defer pipe.Close()
...
func (r *RedisV8) Pop(ctx context.Context, key string, stop int64) ([]string, error) {
