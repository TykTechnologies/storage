...
func (r *RedisV8) AddScoredMember(ctx context.Context, key, member string, score float64) (int64, error) {
...
func (r *RedisV8) GetMembersByScoreRange(ctx context.Context, key, min, max string) ([]interface{}, []float64, error) {
...
func (r *RedisV8) RemoveMembersByScoreRange(ctx context.Context, key, min, max string) (int64, error) {
