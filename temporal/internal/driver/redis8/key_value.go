...
func (r *Redis8) Expire(ctx context.Context, key string, expiration time.Duration) error {
	return r.client.Expire(ctx, key, expiration).Err()
}

// TTL returns the remaining time to live of a key that has a timeout
func (r *Redis8) TTL(ctx context.Context, key string) (int64, error) {
...
func (r *Redis8) DeleteKeys(ctx context.Context, keys []string) (int64, error) {
	return r.client.Del(ctx, keys...).Result()
}

// DeleteScanMatch uses the SCAN command to find all keys matching the given pattern and deletes them
func (r *Redis8) DeleteScanMatch(ctx context.Context, pattern string) (int64, error) {
	var deleted int64
	var cursor uint64
	var err error
...
func (r *Redis8) Keys(ctx context.Context, pattern string) ([]string, error) {
	return r.client.Keys(ctx, pattern).Result()
}

// GetMulti returns the values of all specified keys
func (r *Redis8) GetMulti(ctx context.Context, keys []string) ([]interface{}, error) {
...
func (r *Redis8) GetKeysAndValuesWithFilter(ctx context.Context, pattern string) (map[string]interface{}, error) {
