...
// SetIfExist provides a mock function with given fields: ctx, key, value, expiration
func (_m *KeyValue) SetIfExist(ctx context.Context, key string, value string, expiration time.Duration) (bool, error) {
	ret := _m.Called(ctx, key, value, expiration)

	if len(ret) == 0 {
		panic("no return value specified for SetIfExist")
	}
