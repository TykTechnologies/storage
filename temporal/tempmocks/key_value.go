...
// DeleteAtomic provides a mock function with given fields: ctx, key, opts
func (_m *KeyValue) DeleteAtomic(ctx context.Context, key string, opts ...model.DeleteAtomicOpt) (bool, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for DeleteAtomic")
	}

	var r0 bool
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, ...model.DeleteAtomicOpt) (bool, error)); ok {
		return rf(ctx, key, opts...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, ...model.DeleteAtomicOpt) bool); ok {
		r0 = rf(ctx, key, opts...)
	} else {
		r0 = ret.Get(0).(bool)
	}

	if rf, ok := ret.Get(1).(func(context.Context, string, ...model.DeleteAtomicOpt) error); ok {
		r1 = rf(ctx, key, opts...)
	} else {
		r1 = ret.Error(1)
	}
...
// SetAtomic provides a mock function with given fields: ctx, key, value, expiration
func (_m *KeyValue) SetAtomic(ctx context.Context, key string, value string, expiration time.Duration) (bool, error) {
